...
public class ModbusASCIITransport
  ...
  public ModbusRequest readRequest()
    ...
    try {
      do {
        ...
        synchronized (m_InBuffer) {
          ...
          while ((in = m_InputStream.read()) != FRAME_END) {
            if (in == -1) {
              throw new IOException("ReadMasterRTU: I/O exception - Serial port timeout.");
            }
      ...
      throw new ModbusIOException("ReadMasterRTU: I/O exception - failed to read.");
    }
